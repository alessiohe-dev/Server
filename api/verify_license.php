...
$assignedDeviceId = trim((string)($license['device_id'] ?? ''));
if ($assignedDeviceId === '') api_error('Dieser Lizenz wurde noch keine Device ID zugewiesen.', 409);
if (!hash_equals($assignedDeviceId, $deviceId)) api_error('Device ID und Lizenzschlüssel passen nicht zusammen.', 403);
