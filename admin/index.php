...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (isset($_POST['delete_user'])) {
            ...
            $pdo->beginTransaction();
            $pdo->prepare('DELETE FROM license_activations WHERE license_id = :id')->execute(['id' => $licenseId]);
...
<script>window.DARTSYSTEM_ADMIN={csrf:<?= json_encode(csrf_token()) ?>};</script><script src="/assets/js/admin.js?v=5"></script></body></html>
