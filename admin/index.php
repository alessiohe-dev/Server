...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['admin_login'])) {
    ...
    $error = $adminPassword === null && $adminPasswordHash === null
        ? 'Admin-Zugang ist noch nicht in den Render-Umgebungsvariablen konfiguriert.'
...
try {
    ...
    $error = 'TiDB-Daten konnten nicht geladen werden.';
}
