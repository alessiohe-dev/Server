...
if (!is_admin()):
?>
<!DOCTYPE html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Administration – DartSystem</title><link rel="icon" href="/assets/images/logo-mark.svg?v=2" type="image/svg+xml"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="/assets/css/site.css?v=7"></head><body><main class="admin-login"><form method="post"><a class="brand brand-dark" href="/"><img class="brand-mark" src="/assets/images/logo-mark.svg?v=2" alt="" width="38" height="38"><span>Dart<span>System</span></span></a><p class="kicker">Geschützter Bereich</p><h1>Administration</h1><p>Spieler, Fortschritt und Programmlizenzen verwalten.</p><?php if ($error): ?><div class="notice error"><?= e($error) ?></div><?php endif; ?><input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>"><input type="hidden" name="admin_login" value="1"><label>Benutzername<input name="username" required autocomplete="username" autofocus></label><label>Passwort<input name="password" type="password" required autocomplete="current-password"></label><button class="button">Sicher anmelden →</button><a class="back-link" href="/">← Zur Website</a></form></main></body></html>
<?php exit; endif;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (isset($_POST['delete_user'])) {
            ...
            $licenseId = (int)$_POST['delete_license'];
...
?>
<!DOCTYPE html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Admin – DartSystem</title><link rel="icon" href="/assets/images/logo-mark.svg?v=2" type="image/svg+xml"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="/assets/css/site.css?v=7"></head><body>
<main class="admin-page"><aside class="admin-sidebar"><a class="brand" href="/"><img class="brand-mark" src="/assets/images/logo-mark.svg?v=2" alt="" width="38" height="38"><span>Dart<span>System</span></span></a><small>ADMINISTRATION</small><nav><a class="<?= $tab === 'players' ? 'active' : '' ?>" href="?tab=players"><span>♙</span>Spieler<b><?= count($players) ?></b></a><a class="<?= $tab === 'licenses' ? 'active' : '' ?>" href="?tab=licenses"><span>◇</span>Lizenzen<b><?= count($licenses) ?></b></a><a href="/admin/support.php"><span>✉</span>Support</a><a href="/rangliste.php"><span>↗</span>Rangliste</a><a href="/"><span>⌂</span>Website</a></nav><form method="post"><input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>"><button class="admin-logout" name="admin_logout" value="1">↪ Abmelden</button></form></aside>
...
<script>window.DARTSYSTEM_ADMIN={csrf:<?= json_encode(csrf_token()) ?>};</script><script src="/assets/js/admin.js?v=6"></script></body></html>
